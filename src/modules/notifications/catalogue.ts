...
const OVERTIME_PLACEHOLDERS = {
  ...
  payable: "3h",
  rate: "1.5",
  reference: "OT-2083-0004",
  reason: "Month-end dispatch backlog",
  approver: "Anil Thapa",
  actor: "Anil Thapa",
  comment: "Only the dispatch hours",
  organisation: "Bela Nepal Industries",
};
...
export const CATALOGUE: CatalogueEntry[] = [
  ...
  {
    key: "attendance.overtime_submitted",
    category: "attendance",
    label: "Overtime claim waiting for approval",
    description: "Sent when an employee claims overtime, to the supervisor who approves it.",
    source: "attendance.overtime.submitted",
    severity: "info",
    allowedRecipients: ["approver", "supervisor", "hr"],
    defaultRecipients: ["approver"],
    hrPermission: "attendance.record.viewAll",
    enabled: true,
    inApp: true,
    email: false,
    title: "{{employee}} claimed {{claimed}} overtime for {{date}}",
    body: "{{dayKind}} · {{rate}}× · {{reference}}\nReason: {{reason}}",
    href: "/attendance/overtime?tab=approvals",
    placeholders: OVERTIME_PLACEHOLDERS,
  },
  {
    key: "attendance.overtime_approved",
    category: "attendance",
    label: "Overtime claim approved",
    description: "Tells the employee how much overtime was approved and what it pays.",
    source: "attendance.overtime.approved",
    severity: "success",
    allowedRecipients: ["subject", "supervisor", "hr"],
    defaultRecipients: ["subject"],
    hrPermission: "attendance.record.viewAll",
    ...
    inApp: true,
    email: false,
    title: "Your overtime for {{date}} is approved",
    body: "{{approved}} approved · {{payable}} payable at {{rate}}× · {{reference}} · by {{actor}}",
    href: "/attendance/overtime",
    placeholders: OVERTIME_PLACEHOLDERS,
  },
  {
    key: "attendance.overtime_rejected",
    category: "attendance",
    label: "Overtime claim rejected",
    description: "Tells the employee their overtime claim was refused, and why.",
    source: "attendance.overtime.rejected",
    severity: "danger",
    allowedRecipients: ["subject", "supervisor"],
    defaultRecipients: ["subject"],
    hrPermission: "attendance.record.viewAll",
    ...
    inApp: true,
    email: false,
    title: "Your overtime for {{date}} was not approved",
    body: "{{reference}} · {{actor}}: {{comment}}",
    href: "/attendance/overtime",
    placeholders: OVERTIME_PLACEHOLDERS,
  },
  {
    key: "attendance.overtime_withdrawn",
    category: "attendance",
    label: "Overtime claim withdrawn",
    description: "Tells the approver a claim waiting on them has been withdrawn.",
    source: "attendance.overtime.withdrawn",
    severity: "info",
    ...
    inApp: true,
    email: false,
    title: "{{employee}} withdrew an overtime claim for {{date}}",
    body: "{{claimed}} · {{reference}}",
    href: "/attendance/overtime?tab=approvals",
    placeholders: OVERTIME_PLACEHOLDERS,
  },
