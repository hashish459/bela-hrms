  ...
  // ------------------------------------------------------------------- leave
  {
    ...
    nav: [
      ...
      ready("leave.balances", "Leave Balances", "/leave/balances", "Scale", "leave.balance.manage", "Setup",
        "Every balance for a fiscal year: allocate the year, open any balance to see its history, and adjust it with a reason."),
      ready("leave.types", "Leave Types", "/leave/types", "Tags", "leave.type.manage", "Setup",
        "Create, edit, duplicate, switch off or delete leave types — entitlement, rules, approval route, pay and year-end behaviour."),
      ...
      ready("leave.encashment", "Encashment", "/leave/encashment", "Banknote", "leave.balance.manage", "Year end",
        "Paying out unused entitlement at year end, and the payroll line it produces."),
      ready("leave.lapse", "Lapse & Carry Forward", "/leave/lapse", "ArchiveRestore", "leave.balance.manage", "Year end",
