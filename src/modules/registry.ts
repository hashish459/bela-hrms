...
export const MODULES: ModuleDefinition[] = [
  ...
  // ------------------------------------------------------------- organisation
  {
    ...
    nav: [
      ...
      planned("setup.grades", "Grades & Levels", "/setup/grades", "Layers", "setup.structure.manage", "Structure",
        "Pay grades and the basic salary band attached to each."),
      planned("setup.company", "Company Profile", "/setup/company", "Building2", "setup.structure.manage", "Organisation",
